...
namespace ProteoformSuite
{
    public partial class RawExperimentalComponents : Form
    {
        ...
        {
            //round table values
            dgv_RawQuantComp_MI_masses.Columns["monoisotopic_mass"].DefaultCellStyle.Format = "0.####";
            ...
            //set column header
            dgv_RawQuantComp_MI_masses.Columns["monoisotopic_mass"].HeaderText = "Monoisotopic Mass";
